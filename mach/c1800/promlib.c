/**
 * low-level prom and I/O library for the Cisco 1800 series
...
/*UART for console is at the following address for c1800
  registers appear to be as per the very common 16550
*/
#define UART_BASE 0xFF704500
#define UART_LSR 0x5
...
char *c_verstr(void)
{
    return "Cisco 1800 Series Router";
}
