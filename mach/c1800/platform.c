/* Platform-specific operations for the Cisco 1800 Series router
 ...
 */
#include <types.h>
#include <mach/c1800/platform.h>
#include <mach/c1800/platio.h>
#include <printf.h>
...
uint32_t check_flash()
{
    ...
    if (*ptr != FS_FILE_MAGIC) {
        printf("Flash is not readable. may be ATA/FAT format\n");
        return 0;
    }
